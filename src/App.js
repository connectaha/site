    ...
    <Router>
      <AppStyles>
        <AppHeader px={2}>
          ...
          <Navigation>
            <NavLink fontSize={[2, 3]} p={4} to="/speakers" is={Link}>Speakers</NavLink>
            <NavLink fontSize={[2, 3]}p={4} to="/sponsors" is={Link}>Sponsors</NavLink>
            <NavLink fontSize={[2, 3]} py={4} to="https://www.eventbrite.com/e/connectaha-technology-conference-tickets-71091044227?utm-medium=discovery&utm-campaign=social&utm-content=attendeeshare&aff=escb&utm-source=cp&utm-term=listing" is={Link}>
              <Button fontSize={[1, 2]} bg="action" color="white" border="none">Buy Tickets</Button>
            </NavLink>
          </Navigation>
        </AppHeader>
        <div>
